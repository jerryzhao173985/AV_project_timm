...
#from timm.loss import LabelSmoothingCrossEntropy, SoftTargetCrossEntropy, JsdCrossEntropy, CosineLoss, FocalCosineLoss
...
parser.add_argument('--focalcosine', action='store_true', default=False)
...
def main():
    ...
    if args.cosine:
        train_loss_fn = CosineLoss().cuda()
        validate_loss_fn = nn.CrossEntropyLoss().cuda()
    elif args.focalcosine:
